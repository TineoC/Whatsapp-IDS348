...
export declare function emojiUrl(emojiStyle: EmojiStyle, emoji: DataEmoji, skinTone?: string): string;
...
export declare function emojiUrlByUnified(emojiStyle: EmojiStyle, unified: string): string;
